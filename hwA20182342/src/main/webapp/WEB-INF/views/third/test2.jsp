...
<head>
  ...
  <style>
    ...
    div.title { font-size: 20pt; padding: 10px; background-color: #eee; text-align: center; }
    table { margin: 20px; }
  ...
  <div class="container">
    <form method="post">
      ...
      <table>
        <tr>
          <td>id</td>
          <td><input type="text" name="name" value="${ student.id }" /></td>
        </tr>
        <tr>
          <td>학번</td>
          <td><input type="number" name="weight" value="${ student.studentNumber }" step="0.1" /></td>
        </tr>
        <tr>
          <td>이름</td>
          <td><input type="number" name="weight" value="${ student.studentName }" step="0.1" /></td>
        </tr>
        <tr>
          <td>이메일</td>
          <td><input type="number" name="weight" value="${ student.email }" step="0.1" /></td>
        </tr>
        <tr>
          <td>생년원일</td>
